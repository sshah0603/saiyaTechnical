...
Two caveats. The five populations are compositional, so they sum to 100 percent 
by construction and one going up forces others down. A shift in monocytes and a shift in CD4 T cells are not
